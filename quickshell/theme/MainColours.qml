...
Singleton {
    ...
    readonly property color pulseAccent:  Colour.lightblue800
    readonly property color pulseBase:    Colour.lightblue910
    ...
    readonly property color clock:        Colour.bluegrey910
}
